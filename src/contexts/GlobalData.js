...
async function getGlobalData(ethPrice, oldEthPrice) {
  ...
  try {
    ...
    //console.log("[===prince===]: getGlobalData: result.data", result.data)
    ...
    //console.log("[===prince===]: getGlobalData: oneDayResult.data", oneDayResult.data)
    ...
    //console.log("[===prince===]: getGlobalData: twoDayResult.data", twoDayResult.data)
    ...
    //console.log("[===prince===]: getGlobalData: oneWeekResult.data", oneWeekResult.data)
    ...
    //console.log("[===prince===]: getGlobalData: twoWeekResult.data", twoWeekResult.data)
  ...
  //console.log("[===prince===]: getGlobalData: data", data)
  return data
}
...
const getEthPrice = async () => {
  ...
  try {
    ...
    //console.log("[===prince===]: getEthPrice: getBlockFromTimestamp", oneDayBlock)

    let result = await client.query({
      query: ETH_PRICE(),
      fetchPolicy: 'cache-first',
    })
    //console.log("[===prince===]: getEthPrice: result", result)
    let resultOneDay = await client.query({
      query: ETH_PRICE(oneDayBlock),
      fetchPolicy: 'cache-first',
    })
    //console.log("[===prince===]: getEthPrice: resultOneDay", resultOneDay)
    const currentPrice = result?.data?.bundles[0]?.ethPrice
    //console.log("[===prince===]: getEthPrice: currentPrice", currentPrice)
    const oneDayBackPrice = resultOneDay?.data?.bundles[0]?.ethPrice
    //console.log("[===prince===]: getEthPrice: oneDayBackPrice", oneDayBackPrice)
...
export function useGlobalData() {
  ...
  useEffect(() => {
    async function fetchData() {
      //console.log("[===prince===]: useGlobalData: ethPrice, oldEthPrice", ethPrice, oldEthPrice)
      let globalData = await getGlobalData(ethPrice, oldEthPrice)
      console.log("[===prince===]: useGlobalData: globalData", globalData)

      globalData && update(globalData)

      let allPairs = await getAllPairsOnUniswap()
      //console.log("[===prince===]: useGlobalData: allPairs", allPairs)
      updateAllPairsInUniswap(allPairs)

      let allTokens = await getAllTokensOnUniswap()
      //console.log("[===prince===]: useGlobalData: allTokens", allTokens)
...
export function useEthPrice() {
  ...
  useEffect(() => {
    async function checkForEthPrice() {
      //console.log("[===prince===]: useEthPrice: ethPrice, ethPriceOld", ethPrice, ethPriceOld)
      if (!ethPrice) {
